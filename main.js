...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var pubsub_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! pubsub-js */ \"./node_modules/pubsub-js/src/pubsub.js\");\n/* harmony import */ var pubsub_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(pubsub_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _domElements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./domElements */ \"./src/domElements.js\");\n\n\n\nconst domPropertyGetter = function domPropertyGetter() {\n  function getSelectedUnits() {\n    return _domElements__WEBPACK_IMPORTED_MODULE_1__.unitsSwitchToggleCheckbox.checked ? 'imperial' : 'metric';\n  }\n\n  function getParametersFromFormToFetchWeatherData() {\n    const TOPIC = 'formSubmitted';\n\n    pubsub_js__WEBPACK_IMPORTED_MODULE_0___default().subscribe(TOPIC, () => {\n      const info = {\n        city: _domElements__WEBPACK_IMPORTED_MODULE_1__.form.querySelector('input').value,\n        units: getSelectedUnits(),\n      };\n\n      const NEW_TOPIC = 'fetchData';\n      pubsub_js__WEBPACK_IMPORTED_MODULE_0___default().publish(NEW_TOPIC, info);\n    });\n  }\n\n  function getParametersFromCardToFetchWeatherData() {\n    const TOPIC = 'unitsSwitchToggleClicked';\n\n    pubsub_js__WEBPACK_IMPORTED_MODULE_0___default().subscribe(TOPIC, () => {\n      const info = {\n        city: _domElements__WEBPACK_IMPORTED_MODULE_1__.city.textContent,\n        units: getSelectedUnits(),\n      };\n\n      const NEW_TOPIC = 'fetchData';\n      pubsub_js__WEBPACK_IMPORTED_MODULE_0___default().publish(NEW_TOPIC, info);\n    });\n  }\n\n  function start() {\n    getParametersFromFormToFetchWeatherData();\n    getParametersFromCardToFetchWeatherData();\n  }\n\n  return {\n    start,\n  };\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (domPropertyGetter);\n\n\n//# sourceURL=webpack://weather-app/./src/domPropertyGetter.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _eventListener__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./eventListener */ \"./src/eventListener.js\");\n/* harmony import */ var _domPropertyGetter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./domPropertyGetter */ \"./src/domPropertyGetter.js\");\n/* harmony import */ var _dataFetcher__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dataFetcher */ \"./src/dataFetcher.js\");\n/* harmony import */ var _dataProcessor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dataProcessor */ \"./src/dataProcessor.js\");\n/* harmony import */ var _domHandler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./domHandler */ \"./src/domHandler.js\");\n/* harmony import */ var _geoLocation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./geoLocation */ \"./src/geoLocation.js\");\n\n\n\n\n\n\n\n_eventListener__WEBPACK_IMPORTED_MODULE_0__.default.start();\n(0,_domPropertyGetter__WEBPACK_IMPORTED_MODULE_1__.default)().start();\n_dataFetcher__WEBPACK_IMPORTED_MODULE_2__.default.start();\n_dataProcessor__WEBPACK_IMPORTED_MODULE_3__.default.start();\n_domHandler__WEBPACK_IMPORTED_MODULE_4__.default.start();\n_geoLocation__WEBPACK_IMPORTED_MODULE_5__.default.start();\n\n\n//# sourceURL=webpack://weather-app/./src/index.js?");
